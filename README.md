...
Full-stack engineer who builds things that actually ship. I work across the entire stack — from pixel-perfect frontends to backend architecture, AI integration, mobile, and DevOps. I care about what gets deployed, not just what gets written.

- 🎓 Gold Medalist, Software Engineering @ FAST-NUCES Karachi
- 🧠 Interested in AI-powered products, semantic search, and scalable systems
- 📱 Comfortable going deep on both web and mobile (React Native)
- 🚀 Always open to connecting with engineers and founders working on interesting problems
